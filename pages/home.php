...
<div class="row">
    <div class="info-card col-lg-4 col-md-6 col-sm-12 card">
        <div class="img-card-top-container">
            <img src="assets/image/it_assessments.webp" alt="IT Consulting" class="card-img-top">
        </div>

        <div class="card-body">
            <!--card media-->
            <h5 class="card-title">IT Strategy and Planning</h5>
            <p class="card-text">We can help you develop a comprehensive IT strategy and plan that will help you achieve your business goals.</p>
